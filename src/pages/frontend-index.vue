<template>
  <div class="main wrap clearfix">
    <div class="main-left">
      <div>
        <div class="main-nav">
          <a href="" class="nav-link"><span class="text">头条</span></a>
          <a href="" class="nav-link"><span class="text">直播</span></a>
          <a href="" class="nav-link"><span class="text">沪深</span></a>
          <a href="" class="nav-link"><span class="text">名家</span></a>
        </div>
      </div>
      <div class="home-feeds cards-wrap">
        ...
        <topics-item-none v-else>暂无数据...</topics-item-none>
      </div>
    </div>
